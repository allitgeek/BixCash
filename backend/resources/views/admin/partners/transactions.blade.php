...
@section('content')
    <div class="card">
        <div class="card-header">
            <div>
                <h3 class="card-title">Transactions: {{ $partner->partnerProfile->business_name ?? $partner->name }}</h3>
                <p style="color: #666; margin-top: 0.25rem;">{{ $partner->phone }}</p>
            </div>
            <a href="{{ route('admin.partners.show', $partner) }}" class="btn btn-secondary">Back to Partner Details</a>
        </div>
        <div class="card-body">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background: #f8f9fa; border-bottom: 2px solid #dee2e6;">
                                ...
                                <th style="padding: 0.75rem; text-align: right;">Partner Profit</th>
            ...
            @else
                <div style="text-align: center; padding: 3rem; color: #666;">
                    ...
                    <p>This partner hasn't created any transactions yet.</p>
                </div>
            @endif
