...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div id="file-upload-section-edit" class="form-group" style="display: none;">
                            ...
                            <div id="file-size-warning-edit" style="display: none; margin-top: 0.5rem; padding: 0.5rem; background: #fff3cd; border: 1px solid #ffc107; border-radius: 4px; color: #856404;">
                                <strong>⚠️ Large file detected!</strong> <span id="file-size-message-edit"></span>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // File upload validation with size warnings
            const fileInput = document.getElementById('media_file');
