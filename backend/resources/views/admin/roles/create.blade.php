...
<div class="space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-[#021c47]">Create New Role</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sticky top-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Role Name (Slug) <span class="text-red-500">*</span></label>
                            <input type="text" name="name" value="{{ old('name') }}" required pattern="[a-z0-9_]+" placeholder="e.g., content_manager"
                        ...
                        <div>
                            ...
                            <input type="text" name="display_name" value="{{ old('display_name') }}" required placeholder="e.g., Content Manager"
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" placeholder="Describe what this role can do..."
                                      class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:border-[#93db4d] focus:ring-2 focus:ring-[#93db4d]/20">{{ old('description') }}</textarea>
                        </div>
                        <div>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 rounded border-gray-300 text-[#93db4d] focus:ring-[#93db4d]">
                    ...
                    <div class="border-t border-gray-200 mt-4 pt-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                            <p class="text-2xl font-bold text-[#021c47]" id="selected-count">0</p>
                            <p class="text-xs text-gray-500">permissions selected</p>
                        </div>
                    </div>

                    <div class="mt-4 space-y-2">
                        <button type="submit" class="w-full px-4 py-2.5 bg-[#021c47] text-white rounded-lg hover:bg-[#93db4d] hover:text-[#021c47] transition-colors font-medium">Create Role</button>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="font-semibold text-[#021c47]">Assign Permissions</h2>
                    ...
                    <div class="mb-4 border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            <label class="flex items-start p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                                <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="permission-checkbox mt-1 w-4 h-4 rounded border-gray-300 text-[#93db4d] focus:ring-[#93db4d]" data-group="{{ $group->id }}" onchange="updateCount()">
                                <div class="ml-2">
...
<script>
function updateCount() { document.getElementById('selected-count').textContent = document.querySelectorAll('.permission-checkbox:checked').length; }
