...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-[#021c47]">Create Promotion</h1>
                <p class="text-gray-500 mt-1">Add a new brand promotion to the website</p>
            </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-4">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="discount_type" value="upto" class="w-4 h-4 text-blue-600 focus:ring-blue-500" {{ old('discount_type', 'upto') === 'upto' ? 'checked' : '' }}>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700">UPTO</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="discount_type" value="flat" class="w-4 h-4 text-orange-500 focus:ring-orange-400" {{ old('discount_type') === 'flat' ? 'checked' : '' }}>
                                    ...
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="discount_type" value="coming_soon" class="w-4 h-4 text-purple-600 focus:ring-purple-500" {{ old('discount_type') === 'coming_soon' ? 'checked' : '' }}>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden sticky top-4">
                        ...
                        <div class="p-5">
                            <div class="bg-gray-50 rounded-xl p-6 text-center border border-gray-100">
                                ...
                                <p id="preview-brand" class="font-bold text-[#021c47] text-lg">Brand Name</p>
                                <p id="preview-discount" class="text-sm text-gray-500 mt-1">Discount info</p>
                                <div class="mt-3">
                                    <span id="preview-type-badge" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium uppercase bg-blue-100 text-blue-700">upto</span>
                                </div>
                            </div>
                            <p class="text-xs text-gray-400 text-center mt-3">Live preview updates as you type</p>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateDiscountPreview() {
        ...
        if (type && value && !discountTextInput.value) {
            ...
            if (previewDiscount) previewDiscount.textContent = 'Discount info';
        }
    }
