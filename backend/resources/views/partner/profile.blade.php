                ...
                <div class="relative px-6 py-8">
                    <div class="flex items-center gap-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            @if($partnerProfile->logo)
                            <form method="POST" action="{{ route('partner.profile.remove-logo') }}" class="inline" onsubmit="return confirm('Remove logo? This action cannot be undone.');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="px-3 py-1.5 rounded-lg bg-red-500/90 hover:bg-red-600 text-white text-xs font-semibold shadow-lg transition-all duration-200 flex items-center gap-1.5">
