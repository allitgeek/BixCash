                ...
                <div class="flex flex-col flex-grow bg-[#021c47] overflow-y-auto border-r border-[#93db4d]/20 shadow-xl">
                    ...
                    <div class="flex-1 flex flex-col px-3 py-4 space-y-1">
                        ...
                        <a href="{{ route('admin.explore-partners.index') }}"
                           class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-colors {{ request()->routeIs('admin.explore-partners.*') ? 'bg-[#93db4d] text-white ' : 'text-white/80 hover:bg-white/10 hover:text-white ' }}">
                            <svg class="mr-3 h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <circle cx="12" cy="12" r="9" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12h18M12 3a14 14 0 010 18M12 3a14 14 0 000 18"/>
                            </svg>
                            Explore Partners
                        </a>
        ...
        <nav x-show="mobileMenuOpen"
            ...
            <div class="flex flex-col h-full bg-[#021c47] shadow-xl">
                ...
                <div class="flex-1 min-h-0 max-h-full overflow-y-auto px-3 py-3 space-y-0.5">
                    ...
                    <a href="{{ route('admin.explore-partners.index') }}"
                       @click="mobileMenuOpen = false"
                       class="group flex items-center px-3 py-2.5 text-[0.8125rem] font-medium rounded-lg transition-colors {{ request()->routeIs('admin.explore-partners.*') ? 'bg-[#93db4d] text-white ' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                        <svg class="mr-2.5 h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <circle cx="12" cy="12" r="9" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12h18M12 3a14 14 0 010 18M12 3a14 14 0 000 18"/>
                        </svg>
